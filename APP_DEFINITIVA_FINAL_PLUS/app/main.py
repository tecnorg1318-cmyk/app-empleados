...
def post_aviso(data: dict):
    data["id"]=str(uuid.uuid4())[:8]; data["created_at"]=datetime.now().isoformat(); avisos_db.append(data); save_db(); return data
...
<div class="card" style="border:2px solid #10b981"><h3>💰 Cuánto voy ganando este mes (Empleado 3)</h3><div id="emp-ganancias">Cargando...</div></div>
