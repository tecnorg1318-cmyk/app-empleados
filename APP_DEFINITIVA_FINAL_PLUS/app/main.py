...
if HAS_SQLALCHEMY:
    try:
        ...
        print(f"✅ Base de datos lista: {DATABASE_URL[:30] if DATABASE_URL else DB_SQLITE}")
...
def load_db():
    ...
    # FIX NEON: Si hay DATABASE_URL, cargar desde Postgres (persistente)
